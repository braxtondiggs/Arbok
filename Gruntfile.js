...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      babel: {
        files: ['<%= yeoman.client %>/{app,components,services}/**/!(*.spec|*.mock).js'],
      ...
      injectJS: {
        files: [
          '<%= yeoman.client %>/{app,components,services}/**/!(*.spec|*.mock).js',
      ...
      livereload: {
        files: [
          ...
          '<%= yeoman.client %>/assets/images/{,*//*}*.{png,jpg,jpeg,gif,webp,svg,mp4}'
        ],
        options: {
          livereload: true
        }
    ...
    jshint: {
      ...
      all: ['<%= yeoman.client %>/{app,components,services}/**/!(*.spec|*.mock|app.constant).js'],
      test: {
        src: ['<%= yeoman.client %>/{app,components,services}/**/*.{spec,mock}.js']
      }
    },
    ...
    filerev: {
      dist: {
        src: [
          ...
          '<%= yeoman.dist %>/<%= yeoman.client %>/assets/images/{,*/}*.{png,jpg,jpeg,gif,webp,svg,mp4}',
    ...
    babel: {
      ...
      client: {
        files: [{
          expand: true,
          cwd: '<%= yeoman.client %>',
          src: ['{app,components,services}/**/!(*.spec).js'],
          dest: '.tmp'
        }]
      },
      server: {
